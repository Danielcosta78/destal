...
$('#sidebar .sidebar-content').prepend(`  
  <div class="sidebar-section premium-section">  
    ...
    <!-- Container do PayPal -->  
    <div id="paypal-container-V7HLZPTQNAF8W" class="paypal-container mt-3" style="${activation.active ? 'display:none;' : ''}"></div>  
  </div>  
...
if (!activation.active) {  
  $('.premium-themes-container').hide();  
  // Inicializa o botão do PayPal se premium não estiver ativo
  if (typeof paypal !== 'undefined') {
    paypal.HostedButtons({
      hostedButtonId: "V7HLZPTQNAF8W",
    }).render("#paypal-container-V7HLZPTQNAF8W");
  } else {
    // Se o SDK ainda não carregou, tenta novamente após um delay
    setTimeout(() => {
      if (typeof paypal !== 'undefined') {
        paypal.HostedButtons({
          hostedButtonId: "V7HLZPTQNAF8W",
