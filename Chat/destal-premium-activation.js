            ...
            apply: function() {
                ...
                $('head').append(`
                    <style id="premium-theme-styles">
                        ...
                        .theme-sunset-glow { --bg-color: #fff5e6; --text-color: #b35c00; --card-bg: #ffdca6; --border-color: #f2994a; }
                        .theme-ocean-breeze { --bg-color: #e0f7fa; --text-color: #006064; --card-bg: #b2ebbf2; --border-color: #00acc1; }
                        .theme-forest-mist { --bg-color: #e8f5e9; --text-color: #2e7d32; --card-bg: #c8e6c9; --border-color: #66bb6a; }
                        .theme-lavender-dream { --bg-color: #f3e5f5; --text-color: #6a1b9a; --card-bg: #e1bee7; --border-color: #ab47bc; }
                    </style>
                `);
                ...
                if ($('.premium-emojis-toggle').length === 0) {
                    $('#sidebar .sidebar-content').prepend(`
                        ...
                        <div class="sidebar-section premium-emojis-container" style="display:none;">
                            ...
                            <div class="emoji-grid" style="display:grid; grid-template-columns:repeat(3,1fr); gap:18px; padding:10px; font-size:28px; cursor:pointer; user-select:none; justify-items:center; align-items:center;">
                                <span>🦄</span><span>🧙‍♂️</span><span>🛸</span><span>🐉</span><span>🍀</span><span>🦜</span>
                                <span>🎭</span><span>🌌</span><span>🪐</span><span>🦥</span><span>🦦</span><span>🦩</span>
                                <span>🧛‍♀️</span><span>🧟‍♂️</span><span>🧞‍♂️</span><span>🧜‍♀️</span><span>🦚</span><span>🪶</span>
...
function init() {
    // Adiciona o script do PayPal SDK ao <head>
    $('head').append(`
        <script src="https://www.paypal.com/sdk/js?client-id=BAAkPzm10hAQfwuLQe5bVE_a0ncc5lBvxDLnhJKcBHgSHts8gGaPMjJaOA6Nc4Z34j2IMORrfkjgEnvBB8&components=hosted-buttons&disable-funding=venmo&currency=USD"></script>
    `);
    loadActivation();
    addPremiumSection();
    ...
    $('#sidebar .sidebar-content').prepend(`
        <div class="sidebar-section premium-section">
            ...
            <div class="form-group">
                ...
                <div class="paypal-container mt-2" id="paypal-container-V7HLZPTQNAF8W"></div>
                ${activation.active ? `
